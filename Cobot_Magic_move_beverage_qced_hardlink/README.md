...
### Primary Tasks
move one drink among three beverages.

### Sub-Tasks
This dataset includes 6 distinct subtasks:

1. **End** 
2. **Grasp the beverage bottle placed at the back of the desk** 
3. **Place the drink at the front of the table** 
4. **Pick up the drink** 
5. **Place the beverage bottle to the front of the table** 
6. **null** 
...
```
Cobot_Magic_move_beverage_qced_hardlink/
├── annotations/
